...
int checkFsInit(void *fsptr, size_t fssize)			// We dont need 'path' here. This is just for FS initialization. We know it needs /. and /.. directories.
{
    if(!(fsptr)) //die
    {
